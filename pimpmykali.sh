...
#
# pimpmykali.sh
# Original Author: Dewalt
# Authors: Dewalt, TCM Security / Educate 360 Team
...
# Use is entirely at the user's own risk. The authors and Educate 360 /
# TCM Security assume no liability for any damage, data loss, or other
...
pbb_lab_setup() {
    ...
    wget https://tcmwpmedia.blob.core.windows.net/public/labs/bugbounty-v1.1.zip -O /tmp/pbb-labs.zip
...
peh_weblab_setup() {
    ...
    wget https://tcmwpmedia.blob.core.windows.net/public/labs/peh-web-labs.tar.gz -O /tmp/peh-web-labs.tar.gz
